        ...
        <Card>
          <div className="flex flex-wrap items-start gap-x-6 gap-y-3">
            <label className="min-w-56 flex-1">
              ...
              <textarea className="quietbox" rows={3} value={terms} autoFocus
            ...
            <label className="min-w-56 flex-1">
              ...
              <textarea className="quietbox" rows={3} value={locations}
            ...
            <label className="w-24">
              ...
              <select className="quietbox" value={since}
            ...
            <label className="w-24">
              ...
              <input className="quietbox tnum" type="number" min={1} value={max}
          ...
          <div className="mt-4">
            <button type="button" disabled={busy || !lines(terms).length} onClick={go}
