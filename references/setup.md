...
pacing, so the user sees one map rather than two that disagree. The database starts empty, with no
seed: what the search looks for comes out of the interview, in their words.
