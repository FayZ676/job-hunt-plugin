...
const postings = z.object({
  ...
  location: maybeText,
  remote: maybeInt,
  compensation: maybeText,
  posted_at: maybeText,
  description: maybeText,
  expired: int,
  comp_min: maybeReal,
  comp_max: maybeReal,
  comp_period: maybeText,
  raw: maybeText,
  first_fetched: text,
  last_fetched: text,
  ingested_on: maybeText,
  disposition: DISPOSITION.nullable(),
  canonical_key: maybeText,
  first_seen: maybeText,
  last_seen: maybeText,
  score: maybeInt,
  reason: maybeText,
  resume: maybeText,
  status: POSTING_STATUS.nullable(),
});
...
export const TABLES = {
  identity: z.object({
    id: int,
    full_name: maybeText,
    preferred_name: maybeText,
    last_name: maybeText,
    email: maybeText,
    phone: maybeText,
    location: maybeText,
    street_address: maybeText,
    linkedin: maybeText,
    github: maybeText,
    authorized_in_country_of_residence: maybeInt,
    legal_right_to_work_without_sponsorship: maybeInt,
    requires_sponsorship_now_or_future: maybeInt,
    over_18: maybeInt,
    earliest_daily_start: maybeText,
    notice_period: maybeText,
    employment_type: maybeText,
    remote_preference: maybeText,
    willing_to_relocate: maybeInt,
    compensation_floor: maybeInt,
    compensation_currency: maybeText,
    gender: maybeText,
    race_ethnicity: maybeText,
    hispanic_or_latino: maybeText,
    veteran_status: maybeText,
    disability_status: maybeText,
  }),
  education: z.object({
    id: int,
    degree: text,
    institution: maybeText,
    finished: maybeText,
  }),
  employers: z.object({
    id: int,
  ...
  staged: z.object({
    key: text,
    url: maybeText,
    screenshot: maybeText,
    status: STAGED_STATUS.nullable(),
    blocked_on: maybeText,
  }),
