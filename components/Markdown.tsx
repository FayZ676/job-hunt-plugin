...
const ELEMENTS: Components = {
  ...
  code: ({ children }) => <code className="rounded bg-base-200 px-1 py-0.5 font-mono text-xs">{children}</code>,
  pre: ({ children }) => (
    <pre className="mt-2 overflow-x-auto rounded-box bg-base-200 p-3 font-mono text-xs">{children}</pre>
  ),
  table: ({ children }) => (
  ...
  th: ({ children }) => <th className="border-b border-base-300 py-1 pr-4 font-medium">{children}</th>,
